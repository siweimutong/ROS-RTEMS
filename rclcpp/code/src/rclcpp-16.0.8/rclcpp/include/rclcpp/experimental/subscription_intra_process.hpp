...
extern volatile int64_t g_rclcpp_execute_ns;
#endif
...
//      static_cast<const void *>(&any_callback_));
  ...
  {
#ifdef RTEMS
    struct timespec _td_t0, _td_t1;
    clock_gettime(CLOCK_MONOTONIC, &_td_t0);
#endif
    ...
    auto result = std::static_pointer_cast<void>(
...
#ifdef RTEMS
    clock_gettime(CLOCK_MONOTONIC, &_td_t1);
    g_rclcpp_take_data_ns = (int64_t)((_td_t1.tv_sec - _td_t0.tv_sec)*1000000000LL +
                                       (_td_t1.tv_nsec - _td_t0.tv_nsec));
#endif
