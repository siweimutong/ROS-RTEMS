 ...
 *     Direct intra-process notification.  No spin loop, no rcl_wait.
 *
 ...
 *
 *   FLOW 2: Subscription Callback (intra-process → CBTask)
 *   ───────────────────────────────────────────────────────
 ...
 *         ▼
 *     CallbackTask (user priority, e.g., 50)
 *         │  rtems_event_receive() returns
 *         │  callback_() executes:
 *         │    subscription->take_type_erased()
 *         │    subscription->handle_message()
 *         │    callback_group reset
 *         ▼
 *     Subscription callback in CallbackTask context
 *
 ...
 * =====================================================================
 *
 *   Three targeted modifications to rclcpp enable direct notification:
 *
 ...
 *
 *   These modifications are backward-compatible: if direct_notify_callback_
 *   is not set, the standard guard condition / rcl_wait path is used.
 */
