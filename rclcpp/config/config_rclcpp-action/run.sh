...
source_file="$HOME/RTEMS/quick-start/app/workspace/rclcpp/config/config_rclcpp-action/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librclcpp-action.a"  # Source file (with full path)
