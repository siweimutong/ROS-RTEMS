...
# python ../mk_to_wscript_static.py ../librclcpp-action.mk wscript
...
def build(bld):
    ...
    # rclcpp-action target (static library)
    # Compile and link static library
    bld.stlib(
        target="rclcpp-action",
        source=[
            "init.c",
            "../../../code/src/rclcpp-16.0.8/rclcpp_action/src/client.cpp",
            "../../../code/src/rclcpp-16.0.8/rclcpp_action/src/qos.cpp",
            "../../../code/src/rclcpp-16.0.8/rclcpp_action/src/server.cpp",
            "../../../code/src/rclcpp-16.0.8/rclcpp_action/src/server_goal_handle.cpp",
            "../../../code/src/rclcpp-16.0.8/rclcpp_action/src/types.cpp"
        ],
        includes=[
            "../../../code/src/rclcpp-16.0.8/rclcpp_action/include",
            "../../../../rcl/code/src/rcl-5.3.7/rcl_action/include",
