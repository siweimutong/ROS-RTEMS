...
# python ../mk_to_wscript_static.py ../librclcpp-components.mk wscript
...
def build(bld):
    ...
    # rclcpp-components target (static library)
    # Compile and link static library
    bld.stlib(
        target="rclcpp-components",
        source=[
            "init.c",
            "../../../code/src/rclcpp-16.0.8/rclcpp_components/src/component_manager.cpp"
        ],
        includes=[
            "../../../code/src/rclcpp-16.0.8/rclcpp_components/include",
            "../../../code/src/rclcpp-16.0.8/rclcpp/include",
            "../../../../composition_interfaces/code/src/composition_interfaces/rosidl_generator_cpp",
