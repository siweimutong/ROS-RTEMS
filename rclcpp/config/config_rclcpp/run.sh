...
source_file="$HOME/RTEMS/quick-start/app/workspace/rclcpp/config/config_rclcpp/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librclcpp.a"  # Source file (with full path)
