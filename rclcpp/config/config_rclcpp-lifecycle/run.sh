...
source_file="$HOME/RTEMS/quick-start/app/workspace/rclcpp/config/config_rclcpp-lifecycle/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librclcpp-lifecycle.a"  # Source file (with full path)
