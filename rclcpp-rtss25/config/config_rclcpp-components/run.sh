...
source_file="$HOME/RTEMS/quick-start/app/workspace/rclcpp-rtss25/config/config_rclcpp-components/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librclcpp-components.a"
