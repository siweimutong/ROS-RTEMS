...
# Uses SingleThreadedExecutor from rclcpp-16.0.8 with workspace librclcpp.a
#
set -euo pipefail
...
# Workspace-built rclcpp-16.0.8 librclcpp.a (has g_rclcpp_* symbols)
...
for N in 2 3 4 5 10 15; do
    ...
    MAIN_OBJ="$BUILD_DIR/src/exp3inter_st_main.cpp.${IDX}.o"
...
echo "[2/2] Linking all executables (using workspace rclcpp-16.0.8 librclcpp.a)..."
IDX=1
for N in 2 3 4 5 10 15; do
    TEST_OBJ="$BUILD_DIR/src/test_main.cpp.${IDX}.o"
    MAIN_OBJ="$BUILD_DIR/src/exp3inter_st_main.cpp.${IDX}.o"
    OUTPUT="$BUILD_DIR/exp3inter_st_n${N}.exe"
