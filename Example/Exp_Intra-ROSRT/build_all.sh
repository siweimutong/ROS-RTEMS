#!/bin/bash
#
# build_all.sh — Compile once, then link all chain lengths for Exp_Intra-ROSRT
...
for N in 2 3 4 5; do
    ...
    MAIN_OBJ="$BUILD_DIR/src/exp2_rosrt_main.cpp.${IDX}.o"
...
for N in 2 3 4 5; do
    TEST_OBJ="$BUILD_DIR/src/test_main.cpp.${IDX}.o"
    MAIN_OBJ="$BUILD_DIR/src/exp2_rosrt_main.cpp.${IDX}.o"
    OUTPUT="$BUILD_DIR/exp2_rosrt_n${N}.exe"
