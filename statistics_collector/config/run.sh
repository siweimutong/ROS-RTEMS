...
source_file="$HOME/RTEMS/quick-start/app/workspace/statistics_collector/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libstatistics_collector.a"  # Source file (with full path)
