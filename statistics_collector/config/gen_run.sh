...
log_file_path="$log_path/compile_log_statistics_collector.txt"
...
# python ../mk_to_wscript_static.py ../libstatistics_collector.mk wscript
...
def build(bld):
    ...
    # statistics_collector target (static library)
    # Compile and link static library
    bld.stlib(
        target="statistics_collector",
        source=[
            "init.c",
            "../../code/src/libstatistics_collector/collector/collector.cpp",
            "../../code/src/libstatistics_collector/collector/generate_statistics_message.cpp",
            "../../code/src/libstatistics_collector/moving_average_statistics/moving_average.cpp",
            "../../code/src/libstatistics_collector/moving_average_statistics/types.cpp"
        ],
        includes=[
            "../../code/src/include",
