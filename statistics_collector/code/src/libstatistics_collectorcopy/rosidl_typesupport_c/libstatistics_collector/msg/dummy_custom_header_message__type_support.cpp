...
#include "libstatistics_collector/msg/detail/dummy_custom_header_message__type_support.h"
...
static const _DummyCustomHeaderMessage_type_support_symbol_names_t _DummyCustomHeaderMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, libstatistics_collector, msg, DummyCustomHeaderMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, libstatistics_collector, msg, DummyCustomHeaderMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, libstatistics_collector, msg, DummyCustomHeaderMessage)() {
  return &::libstatistics_collector::msg::rosidl_typesupport_c::DummyCustomHeaderMessage_message_type_support_handle;
}
