...
log_file_path="$log_path/compile_log_rcpputils.txt"
...
# python ../mk_to_wscript_static.py ../librcpputils.mk wscript
...
def build(bld):
    ...
    # rcpputils target (static library)
    # Compile and link static library
    bld.stlib(
        target="rcpputils",
        source=[
            "init.c",
            "../../code/src/rcpputils-2.4.2/src/asserts.cpp",
            "../../code/src/rcpputils-2.4.2/src/env.cpp",
            "../../code/src/rcpputils-2.4.2/src/filesystem_helper.cpp",
            "../../code/src/rcpputils-2.4.2/src/find_library.cpp",
            "../../code/src/rcpputils-2.4.2/src/shared_library.cpp"
        ],
        includes=[
            "../../code/src/rcpputils-2.4.2/include",
        ...
        linkflags="-static",
        lib=["stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c", "rcutils"],
    )
' > wscript
fi
