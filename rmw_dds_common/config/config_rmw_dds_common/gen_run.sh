...
# python ../mk_to_wscript_static.py ../librmw_dds_common.mk wscript
...
def build(bld):
    ...
    # rmw_dds_common target (static library)
    # Compile and link static library
    bld.stlib(
        target="rmw_dds_common",
        source=[
            "init.c",
            "../../../code/src/rmw_dds_common_src/rmw_dds_common/src/gid_utils.cpp",
            "../../../code/src/rmw_dds_common_src/rmw_dds_common/src/graph_cache.cpp",
            "../../../code/src/rmw_dds_common_src/rmw_dds_common/src/qos.cpp",
            "../../../code/src/rmw_dds_common_src/rmw_dds_common/src/security.cpp",
            "../../../code/src/rmw_dds_common_src/rmw_dds_common/src/time_utils.cpp"
        ],
        includes=[
            "../../../code/src/rmw_dds_common_src/rmw_dds_common/include",
