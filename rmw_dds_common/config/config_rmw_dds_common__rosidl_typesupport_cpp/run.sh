...
source_file="$HOME/RTEMS/quick-start/app/workspace/rmw_dds_common/config/config_rmw_dds_common__rosidl_typesupport_cpp/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librmw_dds_common__rosidl_typesupport_cpp.a"  # Source file (with full path)
