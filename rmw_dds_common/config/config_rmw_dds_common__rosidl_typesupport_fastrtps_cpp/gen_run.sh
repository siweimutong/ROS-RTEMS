...
# python ../mk_to_wscript_static.py ../librmw_dds_common__rosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # rmw_dds_common__rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rmw_dds_common__rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_cpp/rmw_dds_common/msg/detail/dds_fastrtps/gid__type_support.cpp",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_cpp/rmw_dds_common/msg/detail/dds_fastrtps/node_entities_info__type_support.cpp",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_cpp/rmw_dds_common/msg/detail/dds_fastrtps/participant_entities_info__type_support.cpp"
        ],
        includes=[
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_cpp",
