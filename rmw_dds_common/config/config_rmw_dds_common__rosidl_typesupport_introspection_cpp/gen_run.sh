...
log_file_path="$log_path/compile_log_rmw_dds_common.txt"
...
# python ../mk_to_wscript_static.py ../librmw_dds_common__rosidl_typesupport_introspection_cpp.mk wscript
...
def build(bld):
    ...
    # rmw_dds_common__rosidl_typesupport_introspection_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rmw_dds_common__rosidl_typesupport_introspection_cpp",
        source=[
            "init.c",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_introspection_cpp/rmw_dds_common/msg/detail/gid__type_support.cpp",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_introspection_cpp/rmw_dds_common/msg/detail/node_entities_info__type_support.cpp",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_introspection_cpp/rmw_dds_common/msg/detail/participant_entities_info__type_support.cpp"
        ],
        includes=[
            "../../../code/src/rmw_dds_common/rosidl_typesupport_introspection_cpp",
            ...
            "../../../code/src/rmw_dds_common/rosidl_generator_cpp",
