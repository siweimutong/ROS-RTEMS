...
# python ../mk_to_wscript_static.py ../librmw_dds_common__rosidl_typesupport_fastrtps_c.mk wscript
...
def build(bld):
    ...
    # rmw_dds_common__rosidl_typesupport_fastrtps_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rmw_dds_common__rosidl_typesupport_fastrtps_c",
        source=[
            "init.c",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_c/rmw_dds_common/msg/detail/gid__type_support_c.cpp",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_c/rmw_dds_common/msg/detail/node_entities_info__type_support_c.cpp",
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_c/rmw_dds_common/msg/detail/participant_entities_info__type_support_c.cpp"
        ],
        includes=[
            "../../../code/src/rmw_dds_common/rosidl_typesupport_fastrtps_c",
