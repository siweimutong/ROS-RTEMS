...
# python ../mk_to_wscript_static.py ../librosgraph_msgs__rosidl_typesupport_cpp.mk wscript
...
def build(bld):
    ...
    # rosgraph_msgs__rosidl_typesupport_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosgraph_msgs__rosidl_typesupport_cpp",
        source=[
            "init.c",
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_cpp/rosgraph_msgs/msg/clock__type_support.cpp"
        ],
        includes=[
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_cpp",
            "../../../../rosidl/code/src/rosidl/rosidl_runtime_c/include",
            "../../../../rosidl/code/src/rosidl/rosidl_typesupport_interface/include",
            "../../../code/src/rosgraph_msgs/rosidl_generator_cpp",
