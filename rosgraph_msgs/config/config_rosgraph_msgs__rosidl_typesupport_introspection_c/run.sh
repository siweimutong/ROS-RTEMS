...
source_file="$HOME/RTEMS/quick-start/app/workspace/rosgraph_msgs/config/config_rosgraph_msgs__rosidl_typesupport_introspection_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librosgraph_msgs__rosidl_typesupport_introspection_c.a"  # Source file (with full path)
