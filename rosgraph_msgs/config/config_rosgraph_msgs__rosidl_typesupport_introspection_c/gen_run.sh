...
log_file_path="$log_path/compile_log_rosgraph_msgs.txt"
...
# python ../mk_to_wscript_static.py ../librosgraph_msgs__rosidl_typesupport_introspection_c.mk wscript
...
def build(bld):
    ...
    # rosgraph_msgs__rosidl_typesupport_introspection_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosgraph_msgs__rosidl_typesupport_introspection_c",
        source=[
            "init.c",
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_introspection_c/rosgraph_msgs/msg/detail/clock__type_support.c"
        ],
        includes=[
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_introspection_c",
            ...
            "../../../code/src/rosgraph_msgs/rosidl_generator_c",
