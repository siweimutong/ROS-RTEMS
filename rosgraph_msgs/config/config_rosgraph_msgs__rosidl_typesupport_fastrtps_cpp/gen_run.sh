...
# python ../mk_to_wscript_static.py ../librosgraph_msgs__rosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # rosgraph_msgs__rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosgraph_msgs__rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_fastrtps_cpp/rosgraph_msgs/msg/detail/dds_fastrtps/clock__type_support.cpp"
        ],
        includes=[
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_fastrtps_cpp",
