...
# python ../mk_to_wscript_static.py ../librosgraph_msgs__rosidl_typesupport_introspection_cpp.mk wscript
...
def build(bld):
    ...
    # rosgraph_msgs__rosidl_typesupport_introspection_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosgraph_msgs__rosidl_typesupport_introspection_cpp",
        source=[
            "init.c",
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_introspection_cpp/rosgraph_msgs/msg/detail/clock__type_support.cpp"
        ],
        includes=[
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_introspection_cpp",
