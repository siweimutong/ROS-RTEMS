...
# python ../mk_to_wscript_static.py ../librosgraph_msgs__rosidl_typesupport_c.mk wscript
...
def build(bld):
    ...
    # rosgraph_msgs__rosidl_typesupport_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosgraph_msgs__rosidl_typesupport_c",
        source=[
            "init.c",
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_c/rosgraph_msgs/msg/clock__type_support.cpp"
        ],
        includes=[
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_c",
