...
# python ../mk_to_wscript_static.py ../librosgraph_msgs__rosidl_typesupport_fastrtps_c.mk wscript
...
def build(bld):
    ...
    # rosgraph_msgs__rosidl_typesupport_fastrtps_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosgraph_msgs__rosidl_typesupport_fastrtps_c",
        source=[
            "init.c",
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_fastrtps_c/rosgraph_msgs/msg/detail/clock__type_support_c.cpp"
        ],
        includes=[
            "../../../code/src/rosgraph_msgs/rosidl_typesupport_fastrtps_c",
