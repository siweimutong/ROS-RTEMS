...
# python ../mk_to_wscript_static.py ../libunique_identifier_msgs__rosidl_typesupport_introspection_c.mk wscript
...
def build(bld):
    ...
    # unique_identifier_msgs__rosidl_typesupport_introspection_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="unique_identifier_msgs__rosidl_typesupport_introspection_c",
        source=[
            "init.c",
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_introspection_c/unique_identifier_msgs/msg/detail/uuid__type_support.c"
        ],
        includes=[
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_introspection_c",
            ...
            "../../../code/src/unique_identifier_msgs/rosidl_generator_c"
        ],
        defines=[
