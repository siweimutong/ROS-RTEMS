...
# python ../mk_to_wscript_static.py ../libunique_identifier_msgs__rosidl_typesupport_introspection_cpp.mk wscript
...
def build(bld):
    ...
    # unique_identifier_msgs__rosidl_typesupport_introspection_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="unique_identifier_msgs__rosidl_typesupport_introspection_cpp",
        source=[
            "init.c",
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_introspection_cpp/unique_identifier_msgs/msg/detail/uuid__type_support.cpp"
        ],
        includes=[
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_introspection_cpp",
