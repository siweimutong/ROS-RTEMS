...
if [[ "$flag" == 1 ]]; then
    ...
    if eval $GIT_CMD; then
        ...
        echo "❌ Failed, possible reasons: network issues / repository not found / path already exists / insufficient permissions" >> $log_file_path 2>&1
...
# python ../mk_to_wscript_static.py ../libunique_identifier_msgs__rosidl_typesupport_cpp.mk wscript
...
def build(bld):
    ...
    # unique_identifier_msgs__rosidl_typesupport_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="unique_identifier_msgs__rosidl_typesupport_cpp",
        source=[
            "init.c",
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_cpp/unique_identifier_msgs/msg/uuid__type_support.cpp"
        ],
        includes=[
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_cpp",
            "../../../../rosidl/code/src/rosidl/rosidl_runtime_c/include",
            "../../../../rosidl/code/src/rosidl/rosidl_typesupport_interface/include",
            "../../../code/src/unique_identifier_msgs/rosidl_generator_cpp",
