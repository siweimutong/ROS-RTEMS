...
# python ../mk_to_wscript_static.py ../libunique_identifier_msgs__rosidl_generator_c.mk wscript
...
def build(bld):
    ...
    # unique_identifier_msgs__rosidl_generator_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="unique_identifier_msgs__rosidl_generator_c",
        source=[
            "init.c",
            "../../../code/src/unique_identifier_msgs/rosidl_generator_c/unique_identifier_msgs/msg/detail/uuid__functions.c"
        ],
        includes=[
