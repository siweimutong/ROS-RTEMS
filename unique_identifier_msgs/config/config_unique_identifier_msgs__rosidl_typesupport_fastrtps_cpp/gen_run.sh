...
# python ../mk_to_wscript_static.py ../libunique_identifier_msgs__rosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # unique_identifier_msgs__rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="unique_identifier_msgs__rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_fastrtps_cpp/unique_identifier_msgs/msg/detail/dds_fastrtps/uuid__type_support.cpp"
        ],
        includes=[
            "../../../code/src/unique_identifier_msgs/rosidl_typesupport_fastrtps_cpp",
