...
# python ../mk_to_wscript_static.py ../liblifecycle_msgs__rosidl_typesupport_introspection_c.mk wscript
...
def build(bld):
    ...
    # lifecycle_msgs__rosidl_typesupport_introspection_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="lifecycle_msgs__rosidl_typesupport_introspection_c",
        source=[
            "init.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/msg/detail/state__type_support.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/msg/detail/transition_description__type_support.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/msg/detail/transition_event__type_support.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/msg/detail/transition__type_support.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/srv/detail/change_state__type_support.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/srv/detail/get_available_states__type_support.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/srv/detail/get_available_transitions__type_support.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c/lifecycle_msgs/srv/detail/get_state__type_support.c"
        ],
        includes=[
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_introspection_c",
