...
# python ../mk_to_wscript_static.py ../liblifecycle_msgs__rosidl_typesupport_c.mk wscript
...
def build(bld):
    ...
    # lifecycle_msgs__rosidl_typesupport_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="lifecycle_msgs__rosidl_typesupport_c",
        source=[
            "init.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/msg/state__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/msg/transition_description__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/msg/transition_event__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/msg/transition__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/srv/change_state__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/srv/get_available_states__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/srv/get_available_transitions__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c/lifecycle_msgs/srv/get_state__type_support.cpp"
        ],
        includes=[
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_c",
