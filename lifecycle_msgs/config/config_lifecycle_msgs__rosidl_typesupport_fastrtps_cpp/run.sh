...
source_file="$HOME/RTEMS/quick-start/app/workspace/lifecycle_msgs/config/config_lifecycle_msgs__rosidl_typesupport_fastrtps_cpp/tmp/build/arm-rtems6-realview_pbx_a9_qemu/liblifecycle_msgs__rosidl_typesupport_fastrtps_cpp.a"  # Source file (with full path)
