...
if [[ "$flag" == 1 ]]; then
    ...
    if eval $GIT_CMD; then
        ...
        # Capture the failure, output the error info, and exit
...
# python ../mk_to_wscript_static.py ../liblifecycle_msgs__rosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # lifecycle_msgs__rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="lifecycle_msgs__rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/msg/detail/dds_fastrtps/state__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/msg/detail/dds_fastrtps/transition_description__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/msg/detail/dds_fastrtps/transition_event__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/msg/detail/dds_fastrtps/transition__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/srv/detail/dds_fastrtps/change_state__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/srv/detail/dds_fastrtps/get_available_states__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/srv/detail/dds_fastrtps/get_available_transitions__type_support.cpp",
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp/lifecycle_msgs/srv/detail/dds_fastrtps/get_state__type_support.cpp"
        ],
        includes=[
            "../../../code/src/lifecycle_msgs/rosidl_typesupport_fastrtps_cpp",
            "../../../../rosidl/code/src/rosidl/rosidl_runtime_c/include",
            "../../../../rosidl/code/src/rosidl/rosidl_typesupport_interface/include",
            "../../../code/src/lifecycle_msgs/rosidl_generator_cpp",
