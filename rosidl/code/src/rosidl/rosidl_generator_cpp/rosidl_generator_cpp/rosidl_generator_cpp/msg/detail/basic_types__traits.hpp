...
#ifndef ROSIDL_GENERATOR_CPP__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
#define ROSIDL_GENERATOR_CPP__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
...
inline void to_yaml(
  const rosidl_generator_cpp::msg::BasicTypes & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_generator_cpp::msg::BasicTypes & msg)
{
...
template<>
inline const char * name<rosidl_generator_cpp::msg::BasicTypes>()
{
  return "rosidl_generator_cpp/msg/BasicTypes";
}
...
#endif  // ROSIDL_GENERATOR_CPP__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
