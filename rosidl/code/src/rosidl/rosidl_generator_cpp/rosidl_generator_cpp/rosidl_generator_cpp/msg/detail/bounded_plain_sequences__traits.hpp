...
#ifndef ROSIDL_GENERATOR_CPP__MSG__DETAIL__BOUNDED_PLAIN_SEQUENCES__TRAITS_HPP_
#define ROSIDL_GENERATOR_CPP__MSG__DETAIL__BOUNDED_PLAIN_SEQUENCES__TRAITS_HPP_
...
inline void to_yaml(
  const rosidl_generator_cpp::msg::BoundedPlainSequences & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_generator_cpp::msg::BoundedPlainSequences & msg)
{
  return rosidl_generator_cpp::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosidl_generator_cpp::msg::BoundedPlainSequences>()
{
  return "rosidl_generator_cpp::msg::BoundedPlainSequences";
}

template<>
inline const char * name<rosidl_generator_cpp::msg::BoundedPlainSequences>()
{
  return "rosidl_generator_cpp/msg/BoundedPlainSequences";
}

template<>
struct has_fixed_size<rosidl_generator_cpp::msg::BoundedPlainSequences>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosidl_generator_cpp::msg::BoundedPlainSequences>
  : std::integral_constant<bool, has_bounded_size<rosidl_generator_cpp::msg::BasicTypes>::value && has_bounded_size<rosidl_generator_cpp::msg::Constants>::value && has_bounded_size<rosidl_generator_cpp::msg::Defaults>::value> {};

template<>
struct is_message<rosidl_generator_cpp::msg::BoundedPlainSequences>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROSIDL_GENERATOR_CPP__MSG__DETAIL__BOUNDED_PLAIN_SEQUENCES__TRAITS_HPP_
