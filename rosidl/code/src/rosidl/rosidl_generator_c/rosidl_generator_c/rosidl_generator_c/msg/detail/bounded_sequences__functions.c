...
rosidl_generator_c__msg__BoundedSequences__create()
{
  ...
  rosidl_generator_c__msg__BoundedSequences * msg = (rosidl_generator_c__msg__BoundedSequences *)allocator.allocate(sizeof(rosidl_generator_c__msg__BoundedSequences), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_c__msg__BoundedSequences__Sequence__init(rosidl_generator_c__msg__BoundedSequences__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_c__msg__BoundedSequences *)allocator.zero_allocate(size, sizeof(rosidl_generator_c__msg__BoundedSequences), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_c__msg__BoundedSequences__Sequence * array = (rosidl_generator_c__msg__BoundedSequences__Sequence *)allocator.allocate(sizeof(rosidl_generator_c__msg__BoundedSequences__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosidl_generator_c__msg__BoundedSequences__Sequence__are_equal(const rosidl_generator_c__msg__BoundedSequences__Sequence * lhs, const rosidl_generator_c__msg__BoundedSequences__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_c__msg__BoundedSequences__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosidl_generator_c__msg__BoundedSequences__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_c__msg__BoundedSequences);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_c__msg__BoundedSequences * data =
      (rosidl_generator_c__msg__BoundedSequences *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_c__msg__BoundedSequences__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_c__msg__BoundedSequences__fini(&output->data[i]);
        }
        return false;
      }
    }
