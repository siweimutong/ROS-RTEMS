...
bool
rosidl_generator_c__msg__Arrays__are_equal(const rosidl_generator_c__msg__Arrays * lhs, const rosidl_generator_c__msg__Arrays * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // constants_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_c__msg__Constants__are_equal(
  ...
  // defaults_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_c__msg__Defaults__are_equal(
...
bool
rosidl_generator_c__msg__Arrays__copy(
  const rosidl_generator_c__msg__Arrays * input,
  rosidl_generator_c__msg__Arrays * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // defaults_values
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_generator_c__msg__Defaults__copy(
...
rosidl_generator_c__msg__Arrays__create()
{
  ...
  rosidl_generator_c__msg__Arrays * msg = (rosidl_generator_c__msg__Arrays *)allocator.allocate(sizeof(rosidl_generator_c__msg__Arrays), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_c__msg__Arrays__Sequence__init(rosidl_generator_c__msg__Arrays__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_c__msg__Arrays *)allocator.zero_allocate(size, sizeof(rosidl_generator_c__msg__Arrays), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_c__msg__Arrays__Sequence * array = (rosidl_generator_c__msg__Arrays__Sequence *)allocator.allocate(sizeof(rosidl_generator_c__msg__Arrays__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rosidl_generator_c__msg__Arrays__Sequence__are_equal(const rosidl_generator_c__msg__Arrays__Sequence * lhs, const rosidl_generator_c__msg__Arrays__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_c__msg__Arrays__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_generator_c__msg__Arrays__Sequence__copy(
  const rosidl_generator_c__msg__Arrays__Sequence * input,
  rosidl_generator_c__msg__Arrays__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_c__msg__Arrays);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_c__msg__Arrays * data =
      (rosidl_generator_c__msg__Arrays *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_c__msg__Arrays__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_c__msg__Arrays__fini(&output->data[i]);
        }
        return false;
      }
    }
