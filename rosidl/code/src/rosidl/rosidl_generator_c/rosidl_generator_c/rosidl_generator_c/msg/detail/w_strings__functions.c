...
#include "rosidl_generator_c/msg/detail/w_strings__functions.h"
...
rosidl_generator_c__msg__WStrings__create()
{
  ...
  rosidl_generator_c__msg__WStrings * msg = (rosidl_generator_c__msg__WStrings *)allocator.allocate(sizeof(rosidl_generator_c__msg__WStrings), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rosidl_generator_c__msg__WStrings__Sequence__init(rosidl_generator_c__msg__WStrings__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rosidl_generator_c__msg__WStrings *)allocator.zero_allocate(size, sizeof(rosidl_generator_c__msg__WStrings), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_generator_c__msg__WStrings__Sequence * array = (rosidl_generator_c__msg__WStrings__Sequence *)allocator.allocate(sizeof(rosidl_generator_c__msg__WStrings__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
rosidl_generator_c__msg__WStrings__Sequence__are_equal(const rosidl_generator_c__msg__WStrings__Sequence * lhs, const rosidl_generator_c__msg__WStrings__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_generator_c__msg__WStrings__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rosidl_generator_c__msg__WStrings__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_generator_c__msg__WStrings);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_generator_c__msg__WStrings * data =
      (rosidl_generator_c__msg__WStrings *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_generator_c__msg__WStrings__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_generator_c__msg__WStrings__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rosidl_generator_c__msg__WStrings__copy(
