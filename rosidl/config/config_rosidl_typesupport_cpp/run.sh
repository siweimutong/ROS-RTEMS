...
source_file="$HOME/RTEMS/quick-start/app/workspace/rosidl/config/config_rosidl_typesupport_cpp/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librosidl_typesupport_cpp.a"  # Source file (with full path)
