...
# python ../mk_to_wscript_static.py ../librosidl_typesupport_introspection_c.mk wscript
...
def build(bld):
    ...
    # rosidl_typesupport_introspection_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosidl_typesupport_introspection_c",
        source=[
            "init.c",
            "../../../code/src/rosidl/rosidl_typesupport_introspection_c/src/identifier.c"
        ],
        includes=[
            "../../../code/src/rosidl/rosidl_typesupport_introspection_c/include"
        ],
        defines=[
