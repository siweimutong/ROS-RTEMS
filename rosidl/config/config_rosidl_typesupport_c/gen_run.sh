...
# python ../mk_to_wscript_static.py ../librosidl_typesupport_c.mk wscript
...
def build(bld):
    ...
    # rosidl_typesupport_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosidl_typesupport_c",
        source=[
            "init.c",
            "../../../code/src/rosidl_typesupport/rosidl_typesupport_c/src/get_func_pointer_by_name.cpp",
            "../../../code/src/rosidl_typesupport/rosidl_typesupport_c/src/identifier.c",
            "../../../code/src/rosidl_typesupport/rosidl_typesupport_c/src/message_type_support_dispatch.cpp",
            "../../../code/src/rosidl_typesupport/rosidl_typesupport_c/src/service_type_support_dispatch.cpp"
        ],
        includes=[
            ...
            "../../../../rcl_interfaces/code/src/rcl_interfaces/rosidl_typesupport_fastrtps_c",
            "../../../code/src/rosidl_typesupport_fastrtps/rosidl_typesupport_fastrtps_c/include",
            "../../../code/src/rosidl/rosidl_runtime_c/include",
            "../../../../DDS/Fast-CDR/code/include",
            "../../../../DDS/Fast-CDR/code/build/include",
            "../../../../builtin_interfaces/code/src/builtin_interfaces/rosidl_typesupport_fastrtps_c",
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "rcpputils", "rcutils", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
