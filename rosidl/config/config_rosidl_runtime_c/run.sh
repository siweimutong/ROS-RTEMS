...
source_file="$HOME/RTEMS/quick-start/app/workspace/rosidl/config/config_rosidl_runtime_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librosidl_runtime_c.a"  # Source file (with full path)
