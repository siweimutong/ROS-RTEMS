...
# python ../mk_to_wscript_static.py ../librosidl_runtime_c.mk wscript
...
def build(bld):
    ...
    # rosidl_runtime_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosidl_runtime_c",
        source=[
            "init.c",
            "../../../code/src/rosidl/rosidl_runtime_c/src/message_type_support.c",
            "../../../code/src/rosidl/rosidl_runtime_c/src/primitives_sequence_functions.c",
            "../../../code/src/rosidl/rosidl_runtime_c/src/sequence_bound.c",
            "../../../code/src/rosidl/rosidl_runtime_c/src/service_type_support.c",
            "../../../code/src/rosidl/rosidl_runtime_c/src/string_functions.c",
            "../../../code/src/rosidl/rosidl_runtime_c/src/u16string_functions.c"
        ],
        includes=[
