...
# python ../mk_to_wscript_static.py ../librosidl_typesupport_introspection_cpp.mk wscript
...
def build(bld):
    ...
    # rosidl_typesupport_introspection_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosidl_typesupport_introspection_cpp",
        source=[
            "init.c",
            "../../../code/src/rosidl/rosidl_typesupport_introspection_cpp/src/identifier.cpp"
        ],
        includes=[
