...
# python ../mk_to_wscript_static.py ../librosidl_typesupport_fastrtps_c.mk wscript
...
def build(bld):
    ...
    # rosidl_typesupport_fastrtps_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosidl_typesupport_fastrtps_c",
        source=[
            "init.c",
            "../../../code/src/rosidl_typesupport_fastrtps/rosidl_typesupport_fastrtps_c/src/identifier.cpp",
            "../../../code/src/rosidl_typesupport_fastrtps/rosidl_typesupport_fastrtps_c/src/wstring_conversion.cpp"
        ],
        includes=[
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
fi
exit 0