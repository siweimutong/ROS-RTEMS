...
./waf build >> $log_file_path 2>&1

# Define source and target directory paths (modify as needed)
source_file="$HOME/RTEMS/quick-start/app/workspace/rosidl/config/config_rosidl_generator_c_interfaces__rosidl_generator_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librosidl_generator_c_interfaces__rosidl_generator_c.a"  # Source file (with full path)
