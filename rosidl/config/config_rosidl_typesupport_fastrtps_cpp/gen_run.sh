...
# python ../mk_to_wscript_static.py ../librosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/rosidl_typesupport_fastrtps/rosidl_typesupport_fastrtps_cpp/src/identifier.cpp",
            "../../../code/src/rosidl_typesupport_fastrtps/rosidl_typesupport_fastrtps_cpp/src/wstring_conversion.cpp"
        ],
        includes=[
