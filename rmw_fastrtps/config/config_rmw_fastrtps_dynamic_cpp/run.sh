...
source_file="$HOME/RTEMS/quick-start/app/workspace/rmw_fastrtps/config/config_rmw_fastrtps_dynamic_cpp/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librmw_fastrtps_dynamic_cpp.a"  # Source file (with full path)
