...
# python ../mk_to_wscript_static.py ../librmw_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # rmw_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="rmw_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/rmw_fastrtps_cpp/src/get_client.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/get_participant.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/get_publisher.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/get_service.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/get_subscriber.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/identifier.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/init_rmw_context_impl.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/publisher.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_client.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_compare_gids_equal.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_count.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_event.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_features.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_get_endpoint_network_flow.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_get_gid_for_publisher.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_get_implementation_identifier.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_get_serialization_format.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_get_topic_endpoint_info.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_guard_condition.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_init.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_logging.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_node.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_node_info_and_types.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_node_names.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_publish.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_publisher.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_qos.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_request.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_response.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_serialize.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_service.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_service_names_and_types.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_service_server_is_available.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_subscription.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_take.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_topic_names_and_types.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_trigger_guard_condition.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_wait.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/rmw_wait_set.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/serialization_format.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/subscription.cpp",
            "../../../code/src/rmw_fastrtps_cpp/src/type_support_common.cpp"
        ],
        includes=[
            "../../../code/src/rmw_fastrtps_cpp/include",
