...
source_file="$HOME/RTEMS/quick-start/app/workspace/ament_index_cpp/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libament_index_cpp.a"  # Source file (with full path)
