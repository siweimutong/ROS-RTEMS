...
log_file_path="$log_path/compile_log_ament_index_cpp.txt"
...
# python ../mk_to_wscript_static.py ../libament_index_cpp.mk wscript
...
def build(bld):
    ...
    # ament_index_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="ament_index_cpp",
        source=[
            "init.c",
            "../../code/src/ament_index_cpp/src/get_packages_with_prefixes.cpp",
            "../../code/src/ament_index_cpp/src/get_package_prefix.cpp",
            "../../code/src/ament_index_cpp/src/get_package_share_directory.cpp",
            "../../code/src/ament_index_cpp/src/get_resource.cpp",
            "../../code/src/ament_index_cpp/src/get_resources.cpp",
            "../../code/src/ament_index_cpp/src/get_search_paths.cpp",
            "../../code/src/ament_index_cpp/src/has_resource.cpp"
        ],
        includes=[
            "../../code/src/ament_index_cpp/include"
        ],
        defines=[
