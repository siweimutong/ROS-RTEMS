#!/bin/bash
#
# run_all_exp6.sh — Run sequentially Exp6-Ours, Exp6-ROSRT
#
# Run from host; launches QEMU inside the rtems6-dev container via docker exec
# Each experiment calls ./run.sh; QEMU and CSV output saved in each Result/ dir
#
set -euo pipefail
...
echo "============================================================"
echo -e "  ${YELLOW}Exp6 Run Summary${NC}"
