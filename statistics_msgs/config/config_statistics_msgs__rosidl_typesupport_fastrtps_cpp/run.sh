...
source_file="$HOME/RTEMS/quick-start/app/workspace/statistics_msgs/config/config_statistics_msgs__rosidl_typesupport_fastrtps_cpp/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libstatistics_msgs__rosidl_typesupport_fastrtps_cpp.a"  # Source file (with full path)
