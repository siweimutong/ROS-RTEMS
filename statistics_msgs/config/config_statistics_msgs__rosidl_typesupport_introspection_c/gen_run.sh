...
# python ../mk_to_wscript_static.py ../libstatistics_msgs__rosidl_typesupport_introspection_c.mk wscript
...
def build(bld):
    ...
    # statistics_msgs__rosidl_typesupport_introspection_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="statistics_msgs__rosidl_typesupport_introspection_c",
        source=[
            "init.c",
            "../../../code/src/statistics_msgs/rosidl_typesupport_introspection_c/statistics_msgs/msg/detail/metrics_message__type_support.c",
            "../../../code/src/statistics_msgs/rosidl_typesupport_introspection_c/statistics_msgs/msg/detail/statistic_data_point__type_support.c",
            "../../../code/src/statistics_msgs/rosidl_typesupport_introspection_c/statistics_msgs/msg/detail/statistic_data_type__type_support.c"
        ],
        includes=[
            "../../../code/src/statistics_msgs/rosidl_typesupport_introspection_c",
            ...
            "../../../code/src/statistics_msgs/rosidl_generator_c",
