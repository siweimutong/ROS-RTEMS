...
# python ../mk_to_wscript_static.py ../libstatistics_msgs__rosidl_generator_c.mk wscript
...
def build(bld):
    ...
    # statistics_msgs__rosidl_generator_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="statistics_msgs__rosidl_generator_c",
        source=[
            "init.c",
            "../../../code/src/statistics_msgs/rosidl_generator_c/statistics_msgs/msg/detail/metrics_message__functions.c",
            "../../../code/src/statistics_msgs/rosidl_generator_c/statistics_msgs/msg/detail/statistic_data_point__functions.c",
            "../../../code/src/statistics_msgs/rosidl_generator_c/statistics_msgs/msg/detail/statistic_data_type__functions.c"
        ],
        includes=[
