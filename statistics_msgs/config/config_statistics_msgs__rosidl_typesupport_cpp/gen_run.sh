...
# python ../mk_to_wscript_static.py ../libstatistics_msgs__rosidl_typesupport_cpp.mk wscript
...
def build(bld):
    ...
    # statistics_msgs__rosidl_typesupport_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="statistics_msgs__rosidl_typesupport_cpp",
        source=[
            "init.c",
            "../../../code/src/statistics_msgs/rosidl_typesupport_cpp/statistics_msgs/msg/metrics_message__type_support.cpp",
            "../../../code/src/statistics_msgs/rosidl_typesupport_cpp/statistics_msgs/msg/statistic_data_point__type_support.cpp",
            "../../../code/src/statistics_msgs/rosidl_typesupport_cpp/statistics_msgs/msg/statistic_data_type__type_support.cpp"
        ],
        includes=[
            "../../../code/src/statistics_msgs/rosidl_typesupport_cpp",
