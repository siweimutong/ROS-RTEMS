...
source_file="$HOME/RTEMS/quick-start/app/workspace/action_msgs/config/config_action_msgs__rosidl_typesupport_fastrtps_cpp/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libaction_msgs__rosidl_typesupport_fastrtps_cpp.a"  # Source file (with full path)
