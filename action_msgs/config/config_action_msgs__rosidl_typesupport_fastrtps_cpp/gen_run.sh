...
# python ../mk_to_wscript_static.py ../libaction_msgs__rosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # action_msgs__rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="action_msgs__rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/action_msgs/rosidl_typesupport_fastrtps_cpp/action_msgs/msg/detail/dds_fastrtps/goal_info__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_fastrtps_cpp/action_msgs/msg/detail/dds_fastrtps/goal_status_array__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_fastrtps_cpp/action_msgs/msg/detail/dds_fastrtps/goal_status__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_fastrtps_cpp/action_msgs/srv/detail/dds_fastrtps/cancel_goal__type_support.cpp"
        ],
        includes=[
            "../../../code/src/action_msgs/rosidl_typesupport_fastrtps_cpp",
