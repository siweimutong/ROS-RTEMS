...
log_file_path="$log_path/compile_log_action_msgs.txt"

if [[ ! -d "$log_path" ]]; then
    mkdir -p "$log_path"  # -pis key: creates build even if no subdirectories exist under root_path
fi

# Check if the log file exists; create it if not found
...
# python ../mk_to_wscript_static.py ../libaction_msgs__rosidl_typesupport_introspection_c.mk wscript
...
def build(bld):
    ...
    # action_msgs__rosidl_typesupport_introspection_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="action_msgs__rosidl_typesupport_introspection_c",
        source=[
            "init.c",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_c/action_msgs/msg/detail/goal_info__type_support.c",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_c/action_msgs/msg/detail/goal_status_array__type_support.c",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_c/action_msgs/msg/detail/goal_status__type_support.c",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_c/action_msgs/srv/detail/cancel_goal__type_support.c"
        ],
        includes=[
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_c",
            ...
            "../../../code/src/action_msgs/rosidl_generator_c",
