...
# python ../mk_to_wscript_static.py ../libaction_msgs__rosidl_typesupport_c.mk wscript
...
def build(bld):
    ...
    # action_msgs__rosidl_typesupport_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="action_msgs__rosidl_typesupport_c",
        source=[
            "init.c",
            "../../../code/src/action_msgs/rosidl_typesupport_c/action_msgs/msg/goal_info__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_c/action_msgs/msg/goal_status_array__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_c/action_msgs/msg/goal_status__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_c/action_msgs/srv/cancel_goal__type_support.cpp"
        ],
        includes=[
            "../../../code/src/action_msgs/rosidl_typesupport_c",
