...
source_file="$HOME/RTEMS/quick-start/app/workspace/action_msgs/config/config_action_msgs__rosidl_generator_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libaction_msgs__rosidl_generator_c.a"  # Source file (with full path)
