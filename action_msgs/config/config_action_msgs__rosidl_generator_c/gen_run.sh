...
# python ../mk_to_wscript_static.py ../libaction_msgs__rosidl_generator_c.mk wscript
...
def build(bld):
    ...
    # action_msgs__rosidl_generator_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="action_msgs__rosidl_generator_c",
        source=[
            "init.c",
            "../../../code/src/action_msgs/rosidl_generator_c/action_msgs/msg/detail/goal_info__functions.c",
            "../../../code/src/action_msgs/rosidl_generator_c/action_msgs/msg/detail/goal_status_array__functions.c",
            "../../../code/src/action_msgs/rosidl_generator_c/action_msgs/msg/detail/goal_status__functions.c",
            "../../../code/src/action_msgs/rosidl_generator_c/action_msgs/srv/detail/cancel_goal__functions.c"
        ],
        includes=[
