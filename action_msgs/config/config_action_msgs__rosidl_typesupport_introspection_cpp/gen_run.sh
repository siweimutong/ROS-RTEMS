...
# python ../mk_to_wscript_static.py ../libaction_msgs__rosidl_typesupport_introspection_cpp.mk wscript
...
def build(bld):
    ...
    # action_msgs__rosidl_typesupport_introspection_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="action_msgs__rosidl_typesupport_introspection_cpp",
        source=[
            "init.c",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/msg/detail/goal_info__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/msg/detail/goal_status_array__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/msg/detail/goal_status__type_support.cpp",
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_cpp/action_msgs/srv/detail/cancel_goal__type_support.cpp"
        ],
        includes=[
            "../../../code/src/action_msgs/rosidl_typesupport_introspection_cpp",
            ...
            "../../../code/src/action_msgs/rosidl_generator_cpp",
