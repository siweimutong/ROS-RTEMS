...
source_file="$HOME/RTEMS/quick-start/app/workspace/rcl_interfaces/config/config_rcl_interfaces__rosidl_typesupport_introspection_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librcl_interfaces__rosidl_typesupport_introspection_c.a"  # Source file (with full path)
