...
# python ../mk_to_wscript_static.py ../libbuiltin_interfaces__rosidl_generator_c.mk wscript
...
def build(bld):
    ...
    # builtin_interfaces__rosidl_generator_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="builtin_interfaces__rosidl_generator_c",
        source=[
            "init.c",
            "../../../code/src/builtin_interfaces/rosidl_generator_c/builtin_interfaces/msg/detail/duration__functions.c",
            "../../../code/src/builtin_interfaces/rosidl_generator_c/builtin_interfaces/msg/detail/time__functions.c"
        ],
        includes=[
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "rcutils", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
