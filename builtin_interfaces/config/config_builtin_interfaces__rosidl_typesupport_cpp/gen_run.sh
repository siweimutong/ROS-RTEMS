...
# python ../mk_to_wscript_static.py ../libbuiltin_interfaces__rosidl_typesupport_cpp.mk wscript
...
def build(bld):
    ...
    # builtin_interfaces__rosidl_typesupport_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="builtin_interfaces__rosidl_typesupport_cpp",
        source=[
            "init.c",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_cpp/builtin_interfaces/msg/duration__type_support.cpp",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_cpp/builtin_interfaces/msg/time__type_support.cpp"
        ],
        includes=[
            "../../../code/src/builtin_interfaces/rosidl_typesupport_cpp",
