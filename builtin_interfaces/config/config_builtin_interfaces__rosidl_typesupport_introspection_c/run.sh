...
source_file="$HOME/RTEMS/quick-start/app/workspace/builtin_interfaces/config/config_builtin_interfaces__rosidl_typesupport_introspection_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libbuiltin_interfaces__rosidl_typesupport_introspection_c.a"  # Source file (with full path)
