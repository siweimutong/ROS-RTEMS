...
# python ../mk_to_wscript_static.py ../libbuiltin_interfaces__rosidl_typesupport_introspection_c.mk wscript
...
def build(bld):
    ...
    # builtin_interfaces__rosidl_typesupport_introspection_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="builtin_interfaces__rosidl_typesupport_introspection_c",
        source=[
            "init.c",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_introspection_c/builtin_interfaces/msg/detail/duration__type_support.c",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_introspection_c/builtin_interfaces/msg/detail/time__type_support.c"
        ],
        includes=[
            "../../../code/src/builtin_interfaces/rosidl_typesupport_introspection_c",
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "rosidl_typesupport_introspection_c", "builtin_interfaces__rosidl_generator_c", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
