...
# python ../mk_to_wscript_static.py ../libbuiltin_interfaces__rosidl_typesupport_c.mk wscript
...
def build(bld):
    ...
    # builtin_interfaces__rosidl_typesupport_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="builtin_interfaces__rosidl_typesupport_c",
        source=[
            "init.c",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_c/builtin_interfaces/msg/duration__type_support.cpp",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_c/builtin_interfaces/msg/time__type_support.cpp"
        ],
        includes=[
            "../../../code/src/builtin_interfaces/rosidl_typesupport_c",
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "builtin_interfaces__rosidl_generator_c", "rosidl_typesupport_c", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
fi
exit 0