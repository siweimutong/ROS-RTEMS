...
# python ../mk_to_wscript_static.py ../libbuiltin_interfaces__rosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # builtin_interfaces__rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="builtin_interfaces__rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_fastrtps_cpp/builtin_interfaces/msg/detail/dds_fastrtps/duration__type_support.cpp",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_fastrtps_cpp/builtin_interfaces/msg/detail/dds_fastrtps/time__type_support.cpp"
        ],
        includes=[
            "../../../code/src/builtin_interfaces/rosidl_typesupport_fastrtps_cpp",
            "../../../../rosidl/code/src/rosidl/rosidl_runtime_c/include",
            "../../../../rosidl/code/src/rosidl/rosidl_typesupport_interface/include",
            "../../../code/src/builtin_interfaces/rosidl_generator_cpp",
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "fastcdr", "rosidl_typesupport_fastrtps_cpp", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
