...
# python ../mk_to_wscript_static.py ../libbuiltin_interfaces__rosidl_typesupport_introspection_cpp.mk wscript
...
def build(bld):
    ...
    # builtin_interfaces__rosidl_typesupport_introspection_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="builtin_interfaces__rosidl_typesupport_introspection_cpp",
        source=[
            "init.c",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_introspection_cpp/builtin_interfaces/msg/detail/duration__type_support.cpp",
            "../../../code/src/builtin_interfaces/rosidl_typesupport_introspection_cpp/builtin_interfaces/msg/detail/time__type_support.cpp"
        ],
        includes=[
            "../../../code/src/builtin_interfaces/rosidl_typesupport_introspection_cpp",
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "rosidl_typesupport_introspection_cpp", "rosidl_typesupport_introspection_c", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
