...
log_file_path="$log_path/compile_log_class_loader.txt"
...
# python ../mk_to_wscript_static.py ../libclass-loader.mk wscript
...
def build(bld):
    ...
    # class-loader target (static library)
    # Compile and link static library
    bld.stlib(
        target="class-loader",
        source=[
            "init.c",
            "../../code/src/class_loader-2.2.0/src/class_loader.cpp",
            "../../code/src/class_loader-2.2.0/src/class_loader_core.cpp",
            "../../code/src/class_loader-2.2.0/src/meta_object.cpp",
            "../../code/src/class_loader-2.2.0/src/multi_library_class_loader.cpp"
        ],
        includes=[
            "../../code/src/class_loader-2.2.0/include",
        ...
        cxxflags="-DRTEMS -frtti -fpermissive -fexceptions -fPIC",
        linkflags="-static",
        lib=["rcpputils", "rcutils", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
