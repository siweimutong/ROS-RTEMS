...
source_file="$HOME/RTEMS/quick-start/app/workspace/class_loader/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libclass-loader.a"  # Source file (with full path)
