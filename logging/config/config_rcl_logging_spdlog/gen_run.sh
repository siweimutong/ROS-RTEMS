...
log_file_path="$log_path/compile_log_logging.txt"
...
# python ../mk_to_wscript_static.py ../librcl_logging_spdlog.mk wscript
...
def build(bld):
    ...
    # rcl_logging_spdlog target (static library)
    # Compile and link static library
    bld.stlib(
        target="rcl_logging_spdlog",
        source=[
            "init.c",
            "../../../code/src/rcl_logging-2.3.1/rcl_logging_spdlog/src/rcl_logging_spdlog.cpp"
        ],
        includes=[
            "../../../code/src/rcl_logging-2.3.1/rcl_logging_interface/include",
            "../../../../rcpputils/code/src/rcpputils-2.4.2/include",
            "../../../../rcutils/code/src/rcutils-5.1.5/include",
            "../../../../spdlog/code/src/spdlog-1.9.2/include"
        ],
        defines=[
            "RMW_IMPLEMENTATION=rmw_fastrtps_cpp",
        ],
        cxxflags="-DRTEMS -fpermissive -fexceptions -Wno-register -g -fPIC -Wno-psabi",
        linkflags="-static",
        lib=[
            "rcpputils",
            "rcutils",
