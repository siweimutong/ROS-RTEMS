...
source_file="$HOME/RTEMS/quick-start/app/workspace/logging/config/config_rcl_logging_spdlog/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librcl_logging_spdlog.a"  # Source file (with full path)
