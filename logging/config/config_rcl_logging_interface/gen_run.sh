...
# python ../mk_to_wscript_static.py ../librcl_logging_interface.mk wscript
...
def build(bld):
    ...
    # rcl_logging_interface target (static library)
    # Compile and link static library
    bld.stlib(
        target="rcl_logging_interface",
        source=[
            "init.c",
            "../../../code/src/rcl_logging-2.3.1/rcl_logging_interface/src/logging_dir.c"
        ],
        includes=[
