...
source_file="$HOME/RTEMS/quick-start/app/workspace/rmw_implementation/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librmw_implementation.a"  # Source file (with full path)
