...
source_file="$HOME/RTEMS/quick-start/app/workspace/example_interfaces/config/config_example_interfaces__rosidl_typesupport_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libexample_interfaces__rosidl_typesupport_c.a"  # Source file (with full path)
