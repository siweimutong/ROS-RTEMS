...
source_file="$HOME/RTEMS/quick-start/app/workspace/std_msgs/config/config_std_msgs__rosidl_generator_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libstd_msgs__rosidl_generator_c.a"  # Source file (with full path)
