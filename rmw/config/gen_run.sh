...
log_file_path="$log_path/compile_log_rmw.txt"
...
# python ../mk_to_wscript_static.py ../librmw.mk wscript
...
def build(bld):
    ...
    # rmw target (static library)
    # Compile and link static library
    bld.stlib(
        target="rmw",
        source=[
            "init.c",
            "../../code/src/rmw-6.1.1/rmw/src/allocators.c",
            "../../code/src/rmw-6.1.1/rmw/src/convert_rcutils_ret_to_rmw_ret.c",
            "../../code/src/rmw-6.1.1/rmw/src/event.c",
            "../../code/src/rmw-6.1.1/rmw/src/init.c",
            "../../code/src/rmw-6.1.1/rmw/src/init_options.c",
            "../../code/src/rmw-6.1.1/rmw/src/message_sequence.c",
            "../../code/src/rmw-6.1.1/rmw/src/names_and_types.c",
            "../../code/src/rmw-6.1.1/rmw/src/network_flow_endpoint.c",
            "../../code/src/rmw-6.1.1/rmw/src/network_flow_endpoint_array.c",
            "../../code/src/rmw-6.1.1/rmw/src/publisher_options.c",
            "../../code/src/rmw-6.1.1/rmw/src/qos_string_conversions.c",
            "../../code/src/rmw-6.1.1/rmw/src/sanity_checks.c",
            "../../code/src/rmw-6.1.1/rmw/src/security_options.c",
            "../../code/src/rmw-6.1.1/rmw/src/subscription_content_filter_options.c",
            "../../code/src/rmw-6.1.1/rmw/src/subscription_options.c",
            "../../code/src/rmw-6.1.1/rmw/src/time.c",
            "../../code/src/rmw-6.1.1/rmw/src/topic_endpoint_info.c",
            "../../code/src/rmw-6.1.1/rmw/src/topic_endpoint_info_array.c",
            "../../code/src/rmw-6.1.1/rmw/src/types.c",
            "../../code/src/rmw-6.1.1/rmw/src/validate_full_topic_name.c",
            "../../code/src/rmw-6.1.1/rmw/src/validate_namespace.c",
            "../../code/src/rmw-6.1.1/rmw/src/validate_node_name.c"
        ],
        includes=[
            "../../code/src/rmw-6.1.1/rmw/include",
        ...
        linkflags="-static",
        lib=["rcutils", "rosidl_runtime_c", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
