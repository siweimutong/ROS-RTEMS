...
# python ../mk_to_wscript_static.py ../libcomposition_interfaces__rosidl_typesupport_fastrtps_cpp.mk wscript
...
def build(bld):
    ...
    # composition_interfaces__rosidl_typesupport_fastrtps_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="composition_interfaces__rosidl_typesupport_fastrtps_cpp",
        source=[
            "init.c",
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_cpp/composition_interfaces/srv/detail/dds_fastrtps/list_nodes__type.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_cpp/composition_interfaces/srv/detail/dds_fastrtps/load_node__type_support.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_cpp/composition_interfaces/srv/detail/dds_fastrtps/unload_node__type.cpp"
        ],
        includes=[
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_cpp",
