...
source_file="$HOME/RTEMS/quick-start/app/workspace/composition_interfaces/config/config_composition_interfaces__rosidl_typesupport_introspection_c/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libcomposition_interfaces__rosidl_typesupport_introspection_c.a"  # Source file (with full path)
