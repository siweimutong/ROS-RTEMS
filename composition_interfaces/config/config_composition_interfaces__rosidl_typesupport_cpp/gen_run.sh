...
# python ../mk_to_wscript_static.py ../libcomposition_interfaces__rosidl_typesupport_cpp.mk wscript
...
def build(bld):
    ...
    # composition_interfaces__rosidl_typesupport_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="composition_interfaces__rosidl_typesupport_cpp",
        source=[
            "init.c",
            "../../../code/src/composition_interfaces/rosidl_typesupport_cpp/composition_interfaces/srv/list_nodes__type_support.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_cpp/composition_interfaces/srv/load_node__type_support.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_cpp/composition_interfaces/srv/unload_node__type_support.cpp"
        ],
        includes=[
            "../../../code/src/composition_interfaces/rosidl_typesupport_cpp",
            "../../../../rosidl/code/src/rosidl/rosidl_runtime_c/include",
            "../../../../rosidl/code/src/rosidl/rosidl_typesupport_interface/include",
            "../../../code/src/composition_interfaces/rosidl_generator_cpp",
