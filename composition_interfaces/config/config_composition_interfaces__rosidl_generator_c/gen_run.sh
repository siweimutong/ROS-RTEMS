...
# python ../mk_to_wscript_static.py ../libcomposition_interfaces__rosidl_generator_c.mk wscript
...
def build(bld):
    ...
    # composition_interfaces__rosidl_generator_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="composition_interfaces__rosidl_generator_c",
        source=[
            "init.c",
            "../../../code/src/composition_interfaces/rosidl_generator_c/composition_interfaces/srv/detail/list_nodes__functions.c",
            "../../../code/src/composition_interfaces/rosidl_generator_c/composition_interfaces/srv/detail/load_node__functions.c",
            "../../../code/src/composition_interfaces/rosidl_generator_c/composition_interfaces/srv/detail/unload_node__functions.c"
        ],
        includes=[
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "rcutils", "rcl_interfaces__rosidl_generator_c", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
