...
log_file_path="$log_path/compile_log_composition_interfaces.txt"
...
if [[ "$flag" == 1 ]]; then
    ...
    if eval $GIT_CMD; then
        ...
        echo "❌ Failed: possible causes - network issues / repository not found / path already exists / insufficient permissions" >> $log_file_path 2>&1
        
        # Optional: output a detailed error log (to help diagnose issues)
...
# python ../mk_to_wscript_static.py ../libcomposition_interfaces__rosidl_typesupport_c.mk wscript
...
def build(bld):
    ...
    # composition_interfaces__rosidl_typesupport_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="composition_interfaces__rosidl_typesupport_c",
        source=[
            "init.c",
            "../../../code/src/composition_interfaces/rosidl_typesupport_c/composition_interfaces/srv/list_nodes__type_support.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_c/composition_interfaces/srv/load_node__type_support.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_c/composition_interfaces/srv/unload_node__type_support.cpp"
        ],
        includes=[
            "../../../code/src/composition_interfaces/rosidl_typesupport_c",
            "../../../../rosidl/code/src/rosidl/rosidl_runtime_c/include",
            "../../../../rosidl/code/src/rosidl/rosidl_typesupport_interface/include",
            "../../../code/src/composition_interfaces/rosidl_generator_c",
        ...
        linkflags="-static",
        lib=["rosidl_runtime_c", "composition_interfaces__rosidl_generator_c", "rosidl_typesupport_c", "rcl_interfaces__rosidl_generator_c", "stdc++", "rtemscpu", "rtemsbsp", "rtemsdefaultconfig", "m", "gcc", "c"],
    )
' > wscript
