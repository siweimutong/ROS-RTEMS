...
# python ../mk_to_wscript_static.py ../libcomposition_interfaces__rosidl_typesupport_introspection_cpp.mk wscript
...
def build(bld):
    ...
    # composition_interfaces__rosidl_typesupport_introspection_cpp target (static library)
    # Compile and link static library
    bld.stlib(
        target="composition_interfaces__rosidl_typesupport_introspection_cpp",
        source=[
            "init.c",
            "../../../code/src/composition_interfaces/rosidl_typesupport_introspection_cpp/composition_interfaces/srv/detail/list_nodes__type_support.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_introspection_cpp/composition_interfaces/srv/detail/load_node__type_support.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_introspection_cpp/composition_interfaces/srv/detail/unload_node__type_support.cpp"
        ],
        includes=[
            "../../../code/src/composition_interfaces/rosidl_typesupport_introspection_cpp",
