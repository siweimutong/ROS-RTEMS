...
# python ../mk_to_wscript_static.py ../libcomposition_interfaces__rosidl_typesupport_fastrtps_c.mk wscript
...
def build(bld):
    ...
    # composition_interfaces__rosidl_typesupport_fastrtps_c target (static library)
    # Compile and link static library
    bld.stlib(
        target="composition_interfaces__rosidl_typesupport_fastrtps_c",
        source=[
            "init.c",
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_c/composition_interfaces/srv/detail/list_nodes__type_support_c.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_c/composition_interfaces/srv/detail/load_node__type_support_c.cpp",
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_c/composition_interfaces/srv/detail/unload_node__type_support_c.cpp"
        ],
        includes=[
            "../../../code/src/composition_interfaces/rosidl_typesupport_fastrtps_c",
