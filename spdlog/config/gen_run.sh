...
log_file_path="$log_path/compile_log_spdlog.txt"
...
# python ../mk_to_wscript_static.py ../libspdlog.mk wscript
...
def build(bld):
    ...
    # spdlog target (static library)
    # Compile and link static library
    bld.stlib(
        target="spdlog",
        source=[
            "init.c",
            "../../code/src/spdlog-1.9.2/src/async.cpp",
            "../../code/src/spdlog-1.9.2/src/cfg.cpp",
            "../../code/src/spdlog-1.9.2/src/color_sinks.cpp",
            "../../code/src/spdlog-1.9.2/src/file_sinks.cpp",
            "../../code/src/spdlog-1.9.2/src/fmt.cpp",
            "../../code/src/spdlog-1.9.2/src/spdlog.cpp",
            "../../code/src/spdlog-1.9.2/src/stdout_sinks.cpp"
        ],
        includes=[
            "../../code/src/spdlog-1.9.2/include"
        ],
        defines=[
           "SPDLOG_COMPILED_LIB",
           "FMT_EXPORT",
        ...
        cxxflags="-DRTEMS -fexceptions -fPIC -Wno-psabi",
        linkflags="-static",
