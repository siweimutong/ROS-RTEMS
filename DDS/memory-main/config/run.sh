...
source_file="$HOME/RTEMS/quick-start/app/workspace/DDS/memory-main/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libfoonathan_memory.a" # Source file (with full path)
