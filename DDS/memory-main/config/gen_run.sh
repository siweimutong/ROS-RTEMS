...
if [[ "$flag" == 1 ]]; then
    ...
    */
    ...
    # python ../mk_to_wscript_static.py ../libfoonathan_memory.mk wscript
...
def build(bld):
    ...
    # foonathan_memory target (static library)
    # Compile and link static library
    bld.stlib(
        target="foonathan_memory",
        source=[
            "init.c",
            "../../code/src/detail/align.cpp",
            "../../code/src/detail/debug_helpers.cpp",
            "../../code/src/detail/assert.cpp",
            "../../code/src/detail/free_list.cpp",
            "../../code/src/detail/free_list_array.cpp",
            "../../code/src/detail/small_free_list.cpp",
            "../../code/src/debugging.cpp",
            "../../code/src/error.cpp",
            "../../code/src/heap_allocator.cpp",
            "../../code/src/iteration_allocator.cpp",
            "../../code/src/malloc_allocator.cpp",
            "../../code/src/memory_arena.cpp",
            "../../code/src/memory_pool.cpp",
            "../../code/src/memory_pool_collection.cpp",
            "../../code/src/memory_stack.cpp",
            "../../code/src/new_allocator.cpp",
            "../../code/src/static_allocator.cpp",
            "../../code/src/temporary_allocator.cpp",
            "../../code/src/virtual_memory.cpp"
        ],
        includes=[
            "../../code/include/foonathan/memory",
            "AL_DSYMBOL := -D__unix_"
        ],
        cxxflags="-Wno-cpp -fpermissive -fexceptions -frtti -std=c++17 -Wno-register -g -Wno-unknown-pragmas -fPIC",
        linkflags="-static",
