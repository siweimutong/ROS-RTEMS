...
source_file="$HOME/RTEMS/quick-start/app/workspace/DDS/Fast-CDR/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libfastcdr.a" # Source file (with full path)
