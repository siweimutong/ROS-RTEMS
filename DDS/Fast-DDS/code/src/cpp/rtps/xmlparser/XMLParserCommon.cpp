 ...
 */
#ifdef SYLIXOS
const char* _VOLATILE1 = "VOLATILE";
#else
 ...
 */
#ifdef SYLIXOS
const char* DDS_UINT8 = "uint8";
const char* DDS_INT8 = "int8";
#else
 ...
 */
#ifdef SYLIXOS
const char* DDS_LONG = "int32";
const char* DDS_ULONG = "uint32";
#else
