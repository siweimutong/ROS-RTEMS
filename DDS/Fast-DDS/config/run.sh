...
source_file="$HOME/RTEMS/quick-start/app/workspace/DDS/Fast-DDS/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libfastrtps.a" # Source file (with full path)
