...
source_file="$HOME/RTEMS/quick-start/app/workspace/DDS/tinyxml2/config/tmp/build/arm-rtems6-realview_pbx_a9_qemu/libtinyxml2.a" # Source file (with full path)
