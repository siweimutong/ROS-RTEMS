...
source_file="$HOME/RTEMS/quick-start/app/workspace/rcl/config/config_rcl-lifecyle/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librcl-lifecyle.a"  # Source file (with full path)
