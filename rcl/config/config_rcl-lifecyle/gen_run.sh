...
# python ../mk_to_wscript_static.py ../librcl-lifecyle.mk wscript
...
def build(bld):
    ...
    # rcl-lifecyle target (static library)
    # Compile and link static library
    bld.stlib(
        target="rcl-lifecyle",
        source=[
            "init.c",
            "../../../code/src/rcl-5.3.7/rcl_lifecycle/src/com_interface.c",
            "../../../code/src/rcl-5.3.7/rcl_lifecycle/src/default_state_machine.c",
            "../../../code/src/rcl-5.3.7/rcl_lifecycle/src/rcl_lifecycle.c",
            "../../../code/src/rcl-5.3.7/rcl_lifecycle/src/transition_map.c"
        ],
        includes=[
            "../../../code/src/rcl-5.3.7/rcl_lifecycle/include",
