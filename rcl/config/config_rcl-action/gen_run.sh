...
# python ../mk_to_wscript_static.py ../librcl-action.mk wscript
...
def build(bld):
    ...
    # rcl-action target (static library)
    # Compile and link static library
    bld.stlib(
        target="rcl-action",
        source=[
            "init.c",
            "../../../code/src/rcl-5.3.7/rcl_action/src/rcl_action/action_client.c",
            "../../../code/src/rcl-5.3.7/rcl_action/src/rcl_action/action_server.c",
            "../../../code/src/rcl-5.3.7/rcl_action/src/rcl_action/goal_handle.c",
            "../../../code/src/rcl-5.3.7/rcl_action/src/rcl_action/goal_state_machine.c",
            "../../../code/src/rcl-5.3.7/rcl_action/src/rcl_action/graph.c",
            "../../../code/src/rcl-5.3.7/rcl_action/src/rcl_action/names.c",
            "../../../code/src/rcl-5.3.7/rcl_action/src/rcl_action/types.c"
        ],
        includes=[
            "../../../code/src/rcl-5.3.7/rcl_action/include",
