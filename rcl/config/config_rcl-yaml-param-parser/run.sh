...
source_file="$HOME/RTEMS/quick-start/app/workspace/rcl/config/config_rcl-yaml-param-parser/tmp/build/arm-rtems6-realview_pbx_a9_qemu/librcl-yaml-param-parser.a"  # Source file (with full path)
