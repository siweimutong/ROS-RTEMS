...
# python ../mk_to_wscript_static.py ../librcl-yaml-param-parser.mk wscript
...
def build(bld):
    ...
    # rcl-yaml-param-parser target (static library)
    # Compile and link static library
    bld.stlib(
        target="rcl-yaml-param-parser",
        source=[
            "init.c",
            "../../../code/src/rcl-5.3.7/rcl_yaml_param_parser/src/add_to_arrays.c",
            "../../../code/src/rcl-5.3.7/rcl_yaml_param_parser/src/namespace.c",
            "../../../code/src/rcl-5.3.7/rcl_yaml_param_parser/src/node_params.c",
            "../../../code/src/rcl-5.3.7/rcl_yaml_param_parser/src/parse.c",
            "../../../code/src/rcl-5.3.7/rcl_yaml_param_parser/src/parser.c",
            "../../../code/src/rcl-5.3.7/rcl_yaml_param_parser/src/yaml_variant.c"
        ],
        includes=[
            "../../../code/src/rcl-5.3.7/rcl_yaml_param_parser/include",
            "../../../../rcutils/code/src/rcutils-5.1.5/include",
            "../../../../rmw/code/src/rmw-6.1.1/rmw/include",
            "../../../../yaml/code/src/libyaml-0.2.5/include"
        ],
        defines=[
